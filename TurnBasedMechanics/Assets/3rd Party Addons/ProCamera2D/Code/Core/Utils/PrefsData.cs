...
namespace Com.LuisPedroFonseca.ProCamera2D
{
    public static class PrefsData
    {
    	...
    	public static string TargetsMidPointColorKey = "Targets Mid PointPosition";
    	...
    	public static string CamTargetPositionColorKey = "Camera Target PointPosition";
    	public static Color CamTargetPositionColorValue = new Color(.3f, .3f, .1f);

    	public static string CamTargetPositionSmoothedColorKey = "Camera Target PointPosition Smoothed";
    	public static Color CamTargetPositionSmoothedColorValue = new Color(.5f, .3f, .1f);

    	public static string CurrentCameraPositionColorKey = "Current Camera PointPosition";
