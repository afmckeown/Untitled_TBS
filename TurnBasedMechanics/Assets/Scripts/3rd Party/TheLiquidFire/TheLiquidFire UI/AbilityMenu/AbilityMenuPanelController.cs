...
public class AbilityMenuPanelController : BaseBehavior 
{
	...
	private List<AbilityMenuEntry> menuEntries = 
        new List<AbilityMenuEntry>(MenuCount);
	...
	public void Hide ()
	{
        ...
        this.AddObserver(
            ...
            Notifications.EasingControlCompletedEvent,
            t
        );
	}
